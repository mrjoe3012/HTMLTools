...
namespace HTMLTools
{
    public class Option : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
        public List<HTMLElement> NestedElements { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        public HTMLBooleanAttribute Selected { get; set; }
