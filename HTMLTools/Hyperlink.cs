...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_a.asp">HyperLink</a>)
    public class HyperLink : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
        ...
        public HTMLFieldAttribute Download { get; set; }
        public HTMLFieldAttribute HREF { get; set; }
        public HTMLFieldAttribute HREFLang { get; set; }
        public HTMLFieldAttribute Media { get; set; }
        public HTMLFieldAttribute Ping { get; set; }
        public HTMLFieldAttribute ReferrerPolicy { get; set; }
        public HTMLFieldAttribute Rel { get; set; }
        public HTMLFieldAttribute Target { get; set; }
        ...
        public HyperLink(string href) : this()
        {
