...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_dl.asp">DescriptionList</a>)
    public class DescriptionList : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
        ...
        public DescriptionList() : base("dl")
        {
