...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_output.asp">Output</a>)
    public class Output : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
        ...
        public HTMLFieldAttribute For { get; set; }
