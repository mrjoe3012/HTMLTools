...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_hn.asp">Heading</a>)
    public class Heading : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
        ...
        public int Importance
        {
            ...
            set
            {
                ...
                if(_importance > 6 || _importance < 1)
                {

                    _importance = _importance > 6 ? 6 : 1;

                    throw new InvalidImportanceException(_importance);
        ...
        private class InvalidImportanceException : Exception
        {
            public InvalidImportanceException(int input) : base(string.Format("Cannot have a heading with importance greater than 6 or less than 1. Importance assigned was: {0}", input))
            { }
        }

        public Heading(int importance) : base(string.Concat('h', importance))
        {
