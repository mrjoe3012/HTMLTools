...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_img.asp">Image</a>)
    public class Image : HTMLElement, IGlobalAttributes, IEventAttributes
    {
        ...
        public HTMLFieldAttribute CrossOrigin { get; set; }
        public HTMLFieldAttribute Height  { get; set; }
        public HTMLFieldAttribute Width { get; set; }
        public HTMLFieldAttribute LongDescription { get; set; }
        public HTMLFieldAttribute ReferrerPolicy { get; set; }
        public HTMLFieldAttribute Sizes { get; set; }
        public HTMLFieldAttribute Source { get; set; }
        public HTMLFieldAttribute SourceSet { get; set; }
        public HTMLFieldAttribute UseMap { get; set; }

        public HTMLBooleanAttribute IsMap { get; set; }
