...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_header.asp">Header</a>)
    public class Header : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
