...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_track.asp">Track</a>)
    public class Track : HTMLElement, IGlobalAttributes, IEventAttributes
    {
        ...
        public HTMLBooleanAttribute Default { get; set; }

        public HTMLFieldAttribute Kind { get; set; }
        public HTMLFieldAttribute Label { get; set; }
        public HTMLFieldAttribute Source { get; set; }
        public HTMLFieldAttribute SourceLang { get; set; }
