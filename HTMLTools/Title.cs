...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_title.asp">Title</a>)
    public class Title : HTMLElement, IGlobalAttributes, INest
    {
        ...
        HTMLFieldAttribute IGlobalAttributes.Title { get; set; }
