...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_table.asp">Table</a>)
    public class Table : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
