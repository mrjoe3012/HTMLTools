...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_form.asp">Form</a>)
    public class Form : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
        ...
        public HTMLFieldAttribute AcceptCharset { get; set; }
        public HTMLFieldAttribute Action { get; set; }
        public HTMLFieldAttribute AutoComplete { get; set; }
        public HTMLFieldAttribute EncType { get; set; }
        public HTMLFieldAttribute Method { get; set; }
        public HTMLFieldAttribute Name { get; set; }
        public HTMLFieldAttribute NoValidate { get; set; }
