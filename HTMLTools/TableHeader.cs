...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_th.asp">TableHeader</a>)
    public class TableHeader : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
        ...
        public HTMLFieldAttribute Abbreviation { get; set; }
        public HTMLFieldAttribute ColumnSpan { get; set; }
        public HTMLFieldAttribute Headers { get; set; }
        public HTMLFieldAttribute RowSpan { get; set; }
        public HTMLFieldAttribute Scope { get; set; }
