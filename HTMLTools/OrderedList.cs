...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_ol.asp">OrderedList</a>)
    public class OrderedList : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
        ...
        public HTMLFieldAttribute Start { get; set; }
        public HTMLFieldAttribute Type { get; set; }
        public HTMLBooleanAttribute Reversed { get; set; }
