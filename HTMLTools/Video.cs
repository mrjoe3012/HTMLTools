...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_video.asp">Video</a>)
    public class Video : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
        ...
        public HTMLBooleanAttribute AutoPlay { get; set; }
        public HTMLBooleanAttribute Controls { get; set; }
        public HTMLBooleanAttribute Loop { get; set; }
        public HTMLBooleanAttribute Muted { get; set; }

        public HTMLFieldAttribute Height { get; set; }
        public HTMLFieldAttribute Width { get; set; }
        public HTMLFieldAttribute Source { get; set; }
        public HTMLFieldAttribute Preload { get; set; }
        public HTMLFieldAttribute Poster { get; set; }
