...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_area.asp">Area</a>)
    public class Area : HTMLElement, IGlobalAttributes, IEventAttributes
    {
        ...
        public HTMLFieldAttribute Coords { get; set; }
        ...
        public HTMLFieldAttribute Shape { get; set; }
