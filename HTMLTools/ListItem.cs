...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_li.asp">ListItem</a>)
    public class ListItem : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
        ...
        public ListItem() : base("li")
        {
            ...
            this.Value = new HTMLFieldAttribute("value");
            this.InitAttributes();
        }
