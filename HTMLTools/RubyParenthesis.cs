...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_rp.asp">RubyParenthesis</a>)
    public class RubyParenthesis : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
        ...
        public RubyParenthesis() : base("rp")
        {
