...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_colgroup.asp">ColumnGroup</a>)
    public class ColumnGroup : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
        ...
        public HTMLFieldAttribute Span { get; set; }

        public ColumnGroup() : base("colgroup")
        {
            this.NestedElements = new List<HTMLElement>();
            this.Span = new HTMLFieldAttribute("span");
            this.InitAttributes();
        }
