...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_section.asp">Section</a>)
    public class Section : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
