...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_col.asp">Column</a>)
    public class Column : HTMLElement, IGlobalAttributes, IEventAttributes
    {
        ...
        public Column() : base("col")
        {
            Span = new HTMLFieldAttribute("span");
            this.InitAttributes();
        }
