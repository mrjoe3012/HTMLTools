...
namespace HTMLTools
{
    //@qdclass(<a target="_blank" href="https://www.w3schools.com/tags/tag_sup.asp">Superscript</a>)
    public class Superscript : HTMLElement, IGlobalAttributes, IEventAttributes, INest
    {
